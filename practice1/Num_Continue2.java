...
public class Num_Continue2 {

	public static void main(String[] args) {

		/*
		 * use continue keyword Print all numbers which are divisible by 3 between 1 and
		 * 100 Print even numbers between 1 to 100 Print odd numbers between 1 to 100
		 * Print only those numbers which are not divisible by 4 between 1 and 100
		 */

		// print all numbers which are divisible by 3 bettween 1-100
